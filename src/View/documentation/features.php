<div class="documentation-layout">
    ...
    <article class="documentation-content">
        ...
        <h2>Bootstrap</h2>
        <ul>
            <li>Singleton bootstrapper with ordered initialization steps</li>
            <li>Load <code>.env</code> configuration from the project root</li>
            <li>Register database connections and discover controllers</li>
            <li>Optional PHP session start</li>
        </ul>
        ...
        <h2>Routing</h2>
        <ul>
            <li>Define routes with PHP <code>#[Route]</code> attributes on controller methods</li>
            <li>HTTP method enum: GET, POST, PUT, PATCH, DELETE</li>
            <li>Typed URL parameters (<code>{:int}</code>, <code>{:str}</code>, <code>*</code>)</li>
            <li>Multiple routes on a single controller method</li>
        </ul>
        ...
        <h2>HTTP</h2>
        <ul>
            <li><strong>Request wrapper</strong> — access URI, HTTP method, <code>$_POST</code>, and raw request body</li>
            <li><strong>Redirects</strong> — <code>redirect()</code> helper sends a <code>Location</code> header and stops execution</li>
        </ul>
        <p>→ <a href="/documentation/requests-and-sessions">Requests and sessions</a> · <a href="/documentation/controllers">Controllers</a></p>
        <h2>Configuration</h2>
        <ul>
            <li>Environment variables via <code>.env</code> and <a href="https://github.com/vlucas/phpdotenv">vlucas/phpdotenv</a></li>
            <li>Named database connections in a <code>DatabaseInfoCollection</code></li>
        </ul>
        <p>→ <a href="/documentation/configuration">Configuration</a></p>
        <h2>Sessions</h2>
        <ul>
            <li><code>getFromSession($key)</code> and <code>setInSession($key, $value)</code> global helpers</li>
            <li>Session started via <code>Bootstrapper::startSession()</code> in your bootstrap</li>
        </ul>
