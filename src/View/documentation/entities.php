        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Marks the primary key column (exactly one per entity)</td>
                </tr>
                <tr>
                    <td><code>#[Column]</code></td>
                    <td>Marks a regular database column</td>
                </tr>
            </tbody>
        </table>
...
$this-&gt;deleteQuery()-&gt;addEntities([$note1, $note2])-&gt;execute();</code></pre>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td><code>getColumnNames()</code></td>
                    <td>All annotated column names</td>
                </tr>
                <tr>
                    <td><code>getPrimaryKeyColumnName()</code></td>
                    <td>Primary key column name</td>
                </tr>
                <tr>
                    <td><code>getValuesArray()</code></td>
                    <td><code>[&#039;column&#039; =&gt; value]</code> for queries</td>
                </tr>
                <tr>
                    <td><code>setId(int|string $id)</code></td>
                    <td>Set primary key after insert</td>
                </tr>
            </tbody>
        </table>
