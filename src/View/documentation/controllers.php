        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Current HTTP request (see <a href="/documentation/requests-and-sessions">Requests and sessions</a>)</td>
                </tr>
                <tr>
                    <td><code>$this-&gt;render($view, $data)</code></td>
                    <td>Render a PHP view from <code>src/View/</code></td>
                </tr>
                <tr>
                    <td><code>$this-&gt;redirect($location)</code></td>
                    <td>Send HTTP redirect and stop execution</td>
                </tr>
            </tbody>
        </table>
...
public function createNote(): void
{
    ...
    $this-&gt;redirect('/notes/get/' . $note-&gt;id);
        ...
        <p>Common patterns:</p>
        <ul>
            <li><strong>GET</strong> — fetch data from the model, render a view</li>
            <li><strong>POST</strong> — read form data, mutate via the model, redirect to avoid duplicate submissions</li>
        </ul>
