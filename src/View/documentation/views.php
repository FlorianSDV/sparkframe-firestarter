...
<pre><code>$this-&gt;render('notes/index', ['notes' =&gt; $notes]);</code></pre>
...
<pre><code>$this-&gt;render('partials/header', $layoutData);
...
<pre><code>&lt;?= htmlspecialchars($note-&gt;text, ENT_QUOTES, 'UTF-8'); ?&gt;</code></pre>
...
<pre><code>&lt;form method="post" action="/notes/create"&gt;
    &lt;textarea name="text" required&gt;&lt;/textarea&gt;
    &lt;button type="submit"&gt;Create&lt;/button&gt;
&lt;/form&gt;</code></pre>
<p>Read submitted values in the controller:</p>
<pre><code>$post = $this-&gt;request-&gt;getRequestPost();
