...
<pre><code>-&gt;whereIn(NoteEntity::ID, [1, 2, 3])
-&gt;whereNotIn(NoteEntity::ID, [4, 5])</code></pre>
<p>Pass another select query as a subquery:</p>
<pre><code>$subquery = $this-&gt;selectQuery()-&gt;select(NoteEntity::ID);
$this-&gt;selectQuery()
...
<pre><code>-&gt;orIn(NoteEntity::ID, [3, 4])
...
<pre><code>public function getAllNotes(): array
{
    return $this-&gt;selectQuery()
        -&gt;select(NoteEntity::ID, NoteEntity::TEXT)
        -&gt;execute();
