        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Request URI string</td>
                    <td><code>$_SERVER[&#039;REQUEST_URI&#039;]</code></td>
                </tr>
                <tr>
                    <td><code>getRequestMethod()</code></td>
                    <td>HTTP method string</td>
                    <td><code>$_SERVER[&#039;REQUEST_METHOD&#039;]</code></td>
                </tr>
                <tr>
                    <td><code>getRequestPost()</code></td>
                    <td>Associative array</td>
                    <td><code>$_POST</code></td>
                </tr>
                <tr>
                    <td><code>getRequestBody()</code></td>
                    <td>Raw body string</td>
...
public function createNote(): void
{
    ...
    echo json_encode(['status' =&gt; 'Success!', 'note' =&gt; $note]);
        ...
        <ol>
            <li>Sends a <code>Location</code> header with the given path</li>
            <li>Calls <code>exit</code> — no code after it runs</li>
        </ol>
