...
<pre><code>#[Route('/notes/create', RequestMethod::POST)]
...
<pre><code>#[Route('/api/notes/create', RequestMethod::POST)]
public function createNote(): void
{
...
<pre><code>$bootstrapper-&gt;startSession();</code></pre>
...
<pre><code>setInSession('user_id', 42);
